...
const outputs = [];
const dataRoot = "/Volumes/T9/cursor/astryx/notebooks/button-lab/data";
const outRoot = "/Volumes/T9/cursor/astryx/notebooks/button-lab/out";
const resultPath = "/Volumes/T9/cursor/astryx/notebooks/button-lab/.astryx/runs/020-020-mq5ygp90-on84n0/result.json";
...
try {
const data = await ctx.data.json("button-matrix.json").catch(() => ({
